...
async def send_messages():
    # Inicia el bot
    bot = aiogram.Bot(token='7210204009:AAE7TIosbyusLuj65HlhEb4F8d951IRrg7U')
    chat_id = -1002207945115
    ...
    for i, line in enumerate(lines, start=1):
        ...
        button_consultas = InlineKeyboardButton("WEBSITE", url="http://trickyabdullah.blogspot.com/")
        ...
        message += f"⌖  Realizado por ⤳ Ͳɾìçҟվ ȺҍժմӀӀąհ\n"
        message += "━━━━━━━━━━━━━━\n"
